...
![bg w:95%](../src/assets/PW/CSS-Selectors.svg)
...
![bg h:95%](../src/assets/PW/CSS-Box-Model.svg)
...
- **Grid** es ideal para organizar elementos en dos dimensiones, como diseños de páginas, formularios o tablas.
- Ambos módulos de CSS son complementarios y se pueden utilizar juntos para crear diseños más complejos y eficientes.
...
- La propiedad `display: grid` se utiliza para definir un contenedor de cuadrícula, que se utiliza para organizar los elementos en filas y columnas.
- Se suele combinar con otras propiedades de Grid, como `grid-template-columns`, `grid-template-rows`, `grid-gap`, `justify-items`, `align-items`, entre otras.

```css
.contenedor {
  display: grid;
  grid-template-columns: 1fr 1fr 1fr; /* 3 columnas de tamaño igual */
  grid-template-rows: 100px 200px; /* 2 filas de tamaño fijo */
...
- Las propiedades `grid-template-columns` y `grid-template-rows` se utilizan para definir el tamaño y la disposición de las columnas y filas de la cuadrícula.
- Se pueden especificar los tamaños de las columnas y filas en píxeles, porcentajes, fracciones, entre otros.
- También se pueden utilizar valores relativos, como `auto`, que ajusta automáticamente el tamaño de la columna o fila al tamaño del contenido.

```css
.contenedor {
  display: grid;
  grid-template-columns: 1fr 2fr 1fr; /* 3 columnas de tamaño relativo */
  grid-template-rows: 100px 200px; /* 2 filas de tamaño fijo */
}
```
...
- `fr` se utiliza para definir el tamaño de las columnas y filas en fracciones, donde 1fr equivale a una fracción del espacio disponible.
- También es posible "repetir" el tamaño de las columnas y filas, utilizando la función `repeat()`: `grid-template-columns: repeat(3, 1fr);`.
...
- `grid-template-columns` y `grid-template-rows` también se pueden combinar con otras propiedades, como `grid-template-areas`, `grid-auto-columns`, `grid-auto-rows`, `grid-auto-flow`, entre otras.
...
- Thomas, J. (2024). _HTML Reference_. <https://htmlreference.io/>
- Thomas, J. (2024). _CSS Reference_. <https://cssreference.io/>

---

# Referencias IV

- Drasner, S. (2024). _CSS Grid Generator_. <https://cssgrid-generator.netlify.app/>
- Retter, K. (2024). _CSS Grid Generator_. <https://cssgridgenerator.io>
- House, C. (2024). _CSS Grid layout Guide_. <https://css-tricks.com/snippets/css/complete-guide-grid/>

---

# Referencias - Josh Comeau ⭐

Corresponde una mención especial a las referencias de Josh Comeau, que contienen información detallada y ejemplos interactivos sobre los temas abordados en esta presentación.

- _Color Formats in CSS_. <https://www.joshwcomeau.com/css/color-formats/>
- _An Interactive Guide to CSS Grid_. <https://www.joshwcomeau.com/css/interactive-guide-to-grid/>
- _An Interactive Guide to Flexbox_. <https://www.joshwcomeau.com/css/interactive-guide-to-flexbox>
- _Make Beautiful Gradients_. <https://www.joshwcomeau.com/css/make-beautiful-gradients/>
