...
::: ok
Es posible cambiar la viñeta, su color y otros atributos, pero para esto se requiere utilzar CSS.
:::
...
<dl>
  <dt>HTML</dt>
  <dd>Lenguaje de marcado de
     hipertexto.</dd>
  <dt>CSS</dt>
  <dd>Lenguaje de hojas de estilo 
    en cascada.</dd>
  <dt>JS</dt>
  <dd>Lenguaje de programación 
    JavaScript.</dd>
